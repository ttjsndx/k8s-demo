...
class Iface(object):
    def sendMobileMessage(self, phone, message):
        """
        Parameters:
         - phone
         - message
...
class Client(Iface):
    ...
    def sendMobileMessage(self, phone, message):
        ...
        Parameters:
         ...
         - message
        """
        self.send_sendMobileMessage(phone, message)
...
class Processor(Iface, TProcessor):
    ...
    def process_sendMobileMessage(self, seqid, iprot, oprot):
        ...
        result = sendMobileMessage_result()
        try:
            result.success = self._handler.sendMobileMessage(args.phone, args.message)
